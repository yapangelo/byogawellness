...
import therapyHero from "../../assets/images/therapy-hero.jpg";

const YogaTherapy = () => {
  return (
    <div className="therapy">
      <section className="therapy__yoga">
        <img
          src={therapyHero}
          alt="Yoga Therapy"
          className="therapy__hero-image"
        />
        <div className="therapy__hero-container">
          <div className="therapy__hero">
          ...
          <div className="therapy__copy">
            ...
            <p className="therapy__copy-paragraph">
              With over fourteen years of practice and teaching experience,
              exposure to various styles of yoga, and an appreciation for the
              unique beauty of diverse bodies, combined with a background in
              nutrition and wellness coaching, I am deeply passionate about
              supporting you on your healing journey. My therapeutic classes
              encourage inquiry and exploration, offering a supportive,
              grounding, and empowering experience. I believe that the
              mind-body-spirit connection is key to cultivating a peaceful,
      ...
      <section className="therapy__copy therapy__copy--end">
        <p className="therapy__copy-paragraph">
        ...
        <p className="therapy__copy-paragraph therapy__copy-paragraph--end">
