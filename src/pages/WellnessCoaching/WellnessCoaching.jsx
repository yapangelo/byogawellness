...
import hero from "../../assets/images/coaching-hero-desktop.jpg";

const WellnessCoaching = () => {
  return (
    <div className="coaching__container">
      <img src={hero} alt="Coaching Hero" className="coaching__img" />
      <div className="coaching__section-container">
        ...
        <section className="coaching__bundles">
          ...
          <div className="coaching__bundles-container">
            ...
            <p className="coaching__bundles-description">
              During a free 15-minute call, we discuss your needs, see if we’re
              a good fit, and determine how to move forward.
            </p>
          </div>

          <div className="coaching__bundles-container">
            <p className="coaching__bundles-name">The Exploration</p>
            <p className="coaching__bundles-duration">
              1.5 months / 3 sessions
            </p>
            <p className="coaching__bundles-description">
          ...
          <div className="coaching__bundles-container">
            ...
            <p className="coaching__bundles-description">
              If you want to go beyond the surface and harness a holistic
              approach to your health and wellness journey, this one’s for you.
            </p>
          </div>
